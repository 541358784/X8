...
{
    public class FailState_SpecialFail : FsmStateBase
    {
        public override void OnEnter(FsmStateParamBase stateParam)
        {
            ...
            var window =
                UIManager.Instance.OpenWindow(UINameConst.UIPopupTileMatchFail, FailTypeEnum.SpecialFail,stateParamBase.BlockTypeEnum) as
