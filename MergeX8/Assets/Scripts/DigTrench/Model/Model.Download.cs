...
namespace DigTrench
{
    public partial class Model
    {
        ...
        public List<AssetGroup> GetNeedDownloadAssetGroups(int levelId)
        {
            ...
            assets.Add(new AssetGroup("DigTrench", $"digtrench/level/leveltype{levelId}.ab"));
            return assets;
        }
        ...
        public List<AssetGroup> GetBaseDownloadAssetGroups()
        {
            ...
            assets.Add(new AssetGroup("DigTrench", $"digtrench/level/leveltype{1}.ab"));
            assets.Add(new AssetGroup("DigTrench", "digtrench/configs.ab"));
            assets.Add(new AssetGroup("DigTrench", "digtrench/prefabs.ab"));
            assets.Add(new AssetGroup("DigTrench", $"spriteatlas/digtrenchatlas/{variantPostFix}.ab"));
            assets.Add(new AssetGroup("DigTrench", "prefabs/uidigtrench.ab"));
            assets.Add(new AssetGroup("DigTrench", "digtrench/texture/items.ab"));
