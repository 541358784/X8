...
namespace Screw
{
    [ViewAsset("Screw/Prefabs/Common/TieLineBody")]
    public class TieLineView : Entity
    {
        ...
        {
            SoundModule.PlaySfx("sfx_obstacle_chain");
        ...
        private void Initialization(int layerId)
        {
            ...
            var startPos = _screwViews[1].GetRoot().position;
            var endPos = _screwViews[0].GetRoot().position;
