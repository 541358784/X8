...
namespace Screw
{
    [Window(UIWindowLayer.Normal, "Screw/Prefabs/PopUp/UIPopupBlockerFail")]
    public partial class UIBlockerFailedPopup:UIWindowController
    {
        ...
        protected override void OnOpenWindow(params object[] objs)
        {
            ...
            var rebornGroup = transform.Find("Root/Item").gameObject.AddComponent<UIKeepPlayingPopup.RebornPackageExtraGroup>();
        ...
        private void LevelRelive(int coin)
        {
            ...
            if (coin > 0)
            {
                var itemChangeReasonArgs = new GameBIManager.ItemChangeReasonArgs()
                {
                    reason = BiEventAdventureIslandMerge.Types.ItemChangeReason.ReliveScrew,
                    data1 = _context.levelIndex.ToString(),
                };
                UserData.UserData.Instance.ConsumeRes(ResType.Coin, coin, itemChangeReasonArgs);
            }
            ...
            UIModule.Instance.CloseWindow(typeof(UIBlockerFailedPopup));
