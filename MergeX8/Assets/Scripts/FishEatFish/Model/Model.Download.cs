...
namespace FishEatFishSpace
{
    public partial class Model
    {
        ...
        public List<AssetGroup> GetBaseDownloadAssetGroups()
        {
            ...
            assets.Add(new AssetGroup("FishEatFish", "fisheatfish/fishdynamic/prefabs/boss.ab"));
            assets.Add(new AssetGroup("FishEatFish", "fisheatfish/fishdynamic/prefabs/enemy.ab"));
            assets.Add(new AssetGroup("FishEatFish", "fisheatfish/fishdynamic/prefabs/items.ab"));
            assets.Add(new AssetGroup("FishEatFish", "fisheatfish/fishdynamic/prefabs/ui.ab"));
            assets.Add(new AssetGroup("FishEatFish", "fisheatfish/configs.ab"));
            assets.Add(new AssetGroup("FishEatFish", $"spriteatlas/fisheatfishatlas/{variantPostFix}.ab"));
            return assets;
        }
