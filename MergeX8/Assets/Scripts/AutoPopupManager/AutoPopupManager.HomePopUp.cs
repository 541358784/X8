...
namespace AutoPopupManager
{
    ...
    {
        private AutoPopUI[] autoPopUIArray;
        
        private void InitHomePopUI()
        {
             autoPopUIArray = new AutoPopUI[]
        {
            //*******************优先级最高 勿动*******************
            ...
            //新破冰礼包
            new AutoPopUI(NewIceBreakGiftBagModel.CanShowNewIceBreakGiftBagOnBackHome, new[] { UINameConst.UIPopupNewbiePack }),
            //卡皮巴拉
        ...
        new AutoPopUI(UIPopupRateUsController.CanShowUI, new[] {""}),
#else
            new AutoPopUI(UIPopupRateUsController.CanShowUI, new[] { UINameConst.UIPopupRateUs }),
#endif
            //LikeUs
            new AutoPopUI(UIPopupLikeUsController.CanShowUI, new[] { UINameConst.UIPopupLikeUs, UINameConst.UIPopupReward }),
            //美人鱼
            ...
            new AutoPopUI(SummerWatermelonModel.CanShowPackagePopupEachDay, new[] { SummerWatermelonModel.Instance.PackageUIPath, UINameConst.UIPopupReward, UINameConst.UIPopupSummerWatermelonMain }),
            //蝴蝶工坊  
