...
{
    public class UIPopupLuckyGoldenEggNoItemController : UIWindowController
    {
        ...
        protected override void OnOpenWindow(params object[] objs)
        {
            ...
            _numText.SetText(LuckyGoldenEggModel.Instance.GetGoldenEgg().ToString());
        }
        ...
        private void OnBtnPlay()
        {
            AnimCloseWindow(() =>
            {
                var ui = UIManager.Instance.GetOpenedUIByPath<UILuckyGoldenEggMainController>(UINameConst.UILuckyGoldenEggMain);
                ui.AnimCloseWindow(() =>
                {
        ...
        {
            AnimCloseWindow(() => { UIManager.Instance.OpenUI(UINameConst.UIPopupLuckyGoldenEggGift); });
        }
