 ...
 namespace DogHopeLeaderBoard
 {
     ...
     public class RewardGroupNode : TransformHolder
     {
         ...
         public virtual void BindPlayer(DogHopeLeaderBoardPlayer player)
         {
     ...
     public class NormalRankNode : RankNode
     {
         public class NormalPlayerNode : TransformHolder
         {
             ...
             private DogHopeLeaderBoardPlayer player;
             public void BindPlayer(DogHopeLeaderBoardPlayer inPlayer)
             {
         ...
         private DogHopeLeaderBoardPlayer player;
         public override void BindPlayer(DogHopeLeaderBoardPlayer inPlayer)
         {
             if (player != null && player.IsMe)
                 EventDispatcher.Instance.RemoveEventListener(EventEnum.UPDATE_HEAD,UpdateHeadIcon);
             player = inPlayer;
     ...
     public abstract class RankNode : TransformHolder
     {
         ...
         public abstract void BindPlayer(DogHopeLeaderBoardPlayer player);
     }
 }