...
{
    public partial class ThreeGiftConfigManager : Manager<ThreeGiftConfigManager>
    {   
        ...
        public void InitConfig(String configJson = null)
        {
            ...
            {
                var ta = ResourcesManager.Instance.LoadResource<TextAsset>("C:/Program Files/Git/threegift");
                if (string.IsNullOrEmpty(ta.text))
                {
                    DebugUtil.LogError("Load C:/Program Files/Git/threegift error!");
                    return;
                }
