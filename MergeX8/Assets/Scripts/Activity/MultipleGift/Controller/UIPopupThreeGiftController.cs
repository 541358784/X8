...
namespace MultipleGift
{
    public class UIPopupThreeGiftController : UIWindowController
    {
        ...
        {
            StoreModel.Instance.Purchase(MultipleGiftModel.Instance.ThreeGiftLevelConfigList.shopId);
            GameBIManager.Instance.SendGameEvent(BiEventAdventureIslandMerge.Types.GameEventType.GameEventOneorallDealsPurchase, MultipleGiftModel.Instance.ThreeGiftLevelConfigList.shopId.ToString());
        ...
        protected override void OnOpenWindow(params object[] objs)
        {
            ...
            var config = MultipleGiftModel.Instance.ThreeGiftLevelConfigList;
            for (int i = 0; i < config.packageList.Length; i++)
            {
                var giftConfig = MultipleGiftModel.Instance.GetThreeGiftConfigById(config.packageList[i]);
        ...
        {
            _timeText.SetText(MultipleGiftModel.Instance.GetActivityLeftTimeString());
        }
    }
}
