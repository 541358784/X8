...
{
    public class UIRabbitRacingOpenBoxController : UIWindowController
    {
        ...
        protected override void OnOpenWindow(params object[] objs)
        {
            ...
            for (int i = 0; i < Rewards.Count; i++)
            {
                if (!UserData.Instance.IsResource(Rewards[i].id))
                {
                    ...
                    {
                        MergeEventType = BiEventAdventureIslandMerge.Types.MergeEventType.MergeChangeReasonRabbitRaceGet,
                        isChange = false,
            ...
            //礼包开启瞬间音效
            UserData.Instance.AddRes(Rewards, new GameBIManager.ItemChangeReasonArgs(BiEventAdventureIslandMerge.Types.ItemChangeReason.RabbitRaceGet));
        ...
        public void OnClickCloseButton()
        {
            ...
            FlyGameObjectManager.Instance.FlyObject(RewardData, CurrencyGroupManager.Instance.currencyController, () =>
            {
                ...
                var main = UIManager.Instance.GetOpenedUIByPath(UINameConst.UIRabbitRacingMain) as UISpeedRaceMainController;
                if (main != null)
                {
        ...
        public static UIRabbitRacingOpenBoxController Open(List<ResData> Rewards, int rank,
            System.Action animEndCall = null)
        {
            var popup = UIManager.Instance.OpenUI(UINameConst.UIRabbitRacingOpenBox, Rewards, rank, animEndCall) as UIRabbitRacingOpenBoxController;
            return popup;
        }
    }
}