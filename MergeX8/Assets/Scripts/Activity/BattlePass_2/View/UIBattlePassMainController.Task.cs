...
namespace Activity.BattlePass_2
{
    public partial class UIBattlePassMainController
    {
        ...
        public void InitTaskView()
        {
            ...
            EventDispatcher.Instance.AddEventListener(EventEnum.BATTLE_PASS_2_REFRESH, BattlePassRefresh);
        }
        ...
        private void BattlePassRefresh(BaseEvent e)
        {
            if (!this)
            {
                EventDispatcher.Instance.RemoveEventListener(EventEnum.BATTLE_PASS_2_REFRESH, BattlePassRefresh);
                return;
            }
