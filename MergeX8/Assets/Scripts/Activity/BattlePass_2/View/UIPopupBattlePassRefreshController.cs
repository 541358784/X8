...
namespace Activity.BattlePass_2
{
    ...
    public class UIPopupBattlePassRefreshController : UIWindowController
    {
        ...
        public override void ClickUIMask()
        {
            ...
            UIManager.Instance.OpenUI(UINameConst.UIBattlePass2Reward, addScore, isRefresh);
        ...
        public static bool CanShow()
        {
            ...
            if (BattlePassTaskModel.Instance.battlePassTask.RefreshTime == CommonUtils.GetTomorrowTimestamp2((long)APIManager.Instance.GetServerTime()))
                return false;
        ...
        public static bool ReissueCache(bool isInit)
        {
            ...
            UIManager.Instance.OpenUI(UINameConst.UIPopupBattlePass2Refresh, BpTaskOpenType.Complete);
            return true;
        }
    }
}