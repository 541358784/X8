 ...
 namespace CoinLeaderBoard
 {
     ...
     public class RewardGroupNode : TransformHolder
     {
         ...
         private List<RewardGroupNode.RewardNode> _rewardNodes;
         ...
         public void BindPlayer(CoinLeaderBoardPlayer player)
         {
     ...
     public class NormalRankNode : RankNode
     {
         public class NormalPlayerNode : TransformHolder
         {
             ...
             private CoinLeaderBoardPlayer player;
             public void BindPlayer(CoinLeaderBoardPlayer inPlayer)
             {
         ...
         public NormalRankNode(Transform transform) : base(transform)
         {
             ...
             if (headIconTransform != null)
                 _headIcon = headIconTransform.GetComponent<Image>();
             var headIconFrameTransform = transform.Find("BG");
             if (headIconFrameTransform != null)
                 _headFrameIcon = headIconFrameTransform.GetComponent<Image>();
             EnableDestroy();
         }
         ...
         private CoinLeaderBoardPlayer player;
         public override void BindPlayer(CoinLeaderBoardPlayer inPlayer)
         {
             if (player != null && player.IsMe)
                 EventDispatcher.Instance.RemoveEventListener(EventEnum.UPDATE_HEAD,UpdateHeadIcon);
             player = inPlayer;
     ...
     public class TopRankNode : RankNode
     {
         ...
         public TopRankNode(Transform transform) : base(transform)
         {
             ...
             _headIcon = transform.Find("Head").GetComponent<Image>();
             _headFrameIcon = transform.Find("Image").GetComponent<Image>();
     ...
     public abstract class RankNode : TransformHolder
     {
         ...
         public abstract void BindPlayer(CoinLeaderBoardPlayer player);
     }
 }