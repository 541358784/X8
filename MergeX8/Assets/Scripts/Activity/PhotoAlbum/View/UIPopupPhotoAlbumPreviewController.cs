...
public class UIPopupPhotoAlbumPreviewController:UIWindowController
{
    ...
    public static UIPopupPhotoAlbumPreviewController Open(StoragePhotoAlbum storagePhotoAlbum)
    {
        return UIManager.Instance.OpenUI(UINameConst.UIPopupPhotoAlbumPreview, storagePhotoAlbum) as
            UIPopupPhotoAlbumPreviewController;
    }
}