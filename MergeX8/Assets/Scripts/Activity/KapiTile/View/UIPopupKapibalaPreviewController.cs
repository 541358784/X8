...
public class UIPopupKapiTilePreviewController:UIWindowController
{
    ...
    public static UIPopupKapiTilePreviewController Open(StorageKapiTile storageKapiTile)
    {
        return UIManager.Instance.OpenUI(UINameConst.UIPopupKapiTilePreview, storageKapiTile) as
            UIPopupKapiTilePreviewController;
    }
}