 ...
 namespace SnakeLadderLeaderBoard
 {
     ...
     public class RewardGroupNode : TransformHolder
     {
         ...
         public virtual void BindPlayer(SnakeLadderLeaderBoardPlayer player)
         {
     ...
     public class NormalRankNode : RankNode
     {
         public class NormalPlayerNode : TransformHolder
         {
             ...
             private SnakeLadderLeaderBoardPlayer player;
             public void BindPlayer(SnakeLadderLeaderBoardPlayer inPlayer)
             {
         ...
         private SnakeLadderLeaderBoardPlayer player;
         public override void BindPlayer(SnakeLadderLeaderBoardPlayer inPlayer)
         {
             player = inPlayer;
             UpdateHeadIcon();
     ...
     public abstract class RankNode : TransformHolder
     {
         ...
         public abstract void BindPlayer(SnakeLadderLeaderBoardPlayer player);
     }
 }