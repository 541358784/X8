...
public partial class UISnakeLadderShopController
{
    public class StoreItemLevel : MonoBehaviour
    {
        private SnakeLadderStoreLevelConfig StoreLevelConfig;
        ...
        public void InitStoreItemLevel(StorageSnakeLadder storage,SnakeLadderStoreLevelConfig storeLevelConfig)
        {
            Storage = storage;
            ...
            {
                var itemConfig = SnakeLadderModel.Instance.StoreItemConfig[StoreLevelConfig.StoreItemList[i]];
    ...
    public class StoreItem : MonoBehaviour
    {
        ...
        public void InitStoreItem(StorageSnakeLadder storage, SnakeLadderStoreItemConfig storeItemConfig,SnakeLadderStoreLevelConfig storeLevelConfig)
        {
            Storage = storage;
    ...
    public abstract class ItemStateBase:MonoBehaviour
    {
        ...
        public SnakeLadderStoreLevelConfig StoreLevelConfig;
        public StorageSnakeLadder Storage;
        private Image Icon;
        ...
        public void InitStoreItemState(StorageSnakeLadder storage, SnakeLadderStoreItemConfig storeItemConfig,SnakeLadderStoreLevelConfig storeLevelConfig)
        {
            Storage = storage;
            StoreItemConfig = storeItemConfig;
            StoreLevelConfig = storeLevelConfig;
    ...
    public class ItemStateNormal : ItemStateBase
    {
        ...
        {
            UIPopupSnakeLadderShopBuyController.Open(StoreItemConfig,Storage);
        }
    ...
    public class LeaderBoardLevel : MonoBehaviour
    {
        ...
        public void InitLeaderBoardLevel(StorageSnakeLadder storage)
        {
            Storage = storage;
            UpdateUI();
        ...
        public void UpdateUI()
        {
            ...
            PercentText.SetTermFormats(SnakeLadderLeaderBoardModel.Instance.LeastEnterBoardScore.ToString());
            BtnText.SetText(SnakeLadderLeaderBoardModel.Instance.LeastEnterBoardScore.ToString());
            ...
            // else
            // {
            //     PercentText.SetText(Storage.LeaderBoardStorage.StarCount + "/" + SnakeLadderLeaderBoardModel.Instance.LeastEnterBoardScore);
            // }
        }
    }
}