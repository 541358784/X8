...
public partial class UISnakeLadderShopController:UIWindowController
{
    ...
    protected override void OnOpenWindow(params object[] objs)
    {
        ...
        UpdateScoreText();
        var storeLevelConfigList = SnakeLadderModel.Instance.StoreLevelConfig;
    ...
    public static UISnakeLadderShopController Open(StorageSnakeLadder storageSnakeLadder)
    {
        return UIManager.Instance.OpenUI(UINameConst.UISnakeLadderShop, storageSnakeLadder) as
            UISnakeLadderShopController;
    }
}