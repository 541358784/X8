...
public class SnakeLadderLeaderBoardPlayerSortController
{
    public StorageSnakeLadderLeaderBoard _storageWeek;
    public StorageSnakeLadderLeaderBoard StorageWeek => _storageWeek;
    private SnakeLadderLeaderBoardPlayerMe _me;
    public SnakeLadderLeaderBoardPlayerMe Me => _me;
    public int MyRank => _me.Rank;

    public SnakeLadderLeaderBoardPlayerSortController(StorageSnakeLadderLeaderBoard storageWeek)
    {
        _storageWeek = storageWeek;
        Players = new Dictionary<int, SnakeLadderLeaderBoardPlayer>();
        
        _me = new SnakeLadderLeaderBoardPlayerMe(this);
    }
        ...
        RepeatedField<global::DragonU3DSDK.Network.API.Protocol.LeaderboardEntry> leadBoardEntryList)
    {
        foreach (var leadBoardEntry in leadBoardEntryList)
        {
            ...
            {
                player = new SnakeLadderLeaderBoardPlayerOtherRealPeople(this);
    ...
    // public List<SnakeLadderLeaderBoardPlayer> tempPlayerList = new List<SnakeLadderLeaderBoardPlayer>();
    ...
    public Dictionary<int,SnakeLadderLeaderBoardPlayer> Players;
    private List<Action<SnakeLadderLeaderBoardPlayer>> _onRankChange;
    public void BindRankChangeAction(Action<SnakeLadderLeaderBoardPlayer> onRankChange)
    {
        if (_onRankChange == null)
            _onRankChange = new List<Action<SnakeLadderLeaderBoardPlayer>>();
        if (!_onRankChange.Contains(onRankChange))
            _onRankChange.Add(onRankChange);
    }

    public void UnBindRankChangeAction(Action<SnakeLadderLeaderBoardPlayer> onRankChange)
    {
        _onRankChange.Remove(onRankChange);
    }

    public void OnRankChange(SnakeLadderLeaderBoardPlayer rankChangePlayer)
    {
        if (_onRankChange != null)
        {
...
public abstract class SnakeLadderLeaderBoardPlayer
{
    public SnakeLadderLeaderBoardPlayer(SnakeLadderLeaderBoardPlayerSortController controller)
    {
        _controller = controller;
    }

    public abstract void UpdateStateWithServerData(DragonU3DSDK.Network.API.Protocol.LeaderboardEntry serverData);
    public SnakeLadderLeaderBoardPlayerSortController _controller;
    protected abstract SnakeLadderLeaderBoardPlayerServerStruct GetValue();
    ...
    public SnakeLadderLeaderBoardPlayerServerStruct CurrentStruct;
    private int CurRank;
...
public class SnakeLadderLeaderBoardPlayerMe : SnakeLadderLeaderBoardPlayer
{
    ...
    private SnakeLadderLeaderBoardPlayerServerStruct _storagePlayer;
    public SnakeLadderLeaderBoardPlayerMe(SnakeLadderLeaderBoardPlayerSortController controller) :
        base(controller)
    {
        _storagePlayer = new SnakeLadderLeaderBoardPlayerServerStruct()
        {
    ...
    {
        _storagePlayer.SetValue(SnakeLadderLeaderBoardPlayerServerStruct.HandleServerRobotData(serverData));
        Rank = (int) serverData.Rank;
        RefreshValue();
    }

    protected override SnakeLadderLeaderBoardPlayerServerStruct GetValue()
    {
...
public class SnakeLadderLeaderBoardPlayerOtherRealPeople : SnakeLadderLeaderBoardPlayer
{
    public override AvatarViewState GetAvatarViewState()
    {
    ...
    public SnakeLadderLeaderBoardPlayerOtherRealPeople(SnakeLadderLeaderBoardPlayerSortController controller) :
        base(controller)
    {
        _storagePlayer = new SnakeLadderLeaderBoardPlayerServerStruct();
    }
