...
namespace TMatch
{
    [AssetAddress("Prefabs/Activity/Kapibala/UIKapibalaLevelPause")]
    public class UIKapibalaLevelPauseController : UIPopup
    {
        ...
        {
            UIViewSystem.Instance.Close<UIKapibalaLevelPauseController>();
        }
