...
namespace Activity.BattlePass
{
    public class BattlePassTaskModel : Singleton<BattlePassTaskModel>
    {
        ...
        {
            EventDispatcher.Instance.RemoveEventListener(EventEnum.BATTLE_PASS_TASK_REFRESH, TaskRefresh);
            EventDispatcher.Instance.AddEventListener(EventEnum.BATTLE_PASS_TASK_REFRESH, TaskRefresh);
            ...
            battlePassTask.RefreshTime = CommonUtils.GetTomorrowTimestamp((long)APIManager.Instance.GetServerTime());
        ...
        public void Refresh()
        {
            ...
            EventDispatcher.Instance.DispatchEvent(EventEnum.BATTLE_PASS_REFRESH);
        }
        ...
        private bool TaskRefresh(StorageBattlePassTaskInfo info, TaskType type, int param, int num, bool isSendEvent)
        {
            ...
            if(isSendEvent)
                EventDispatcher.Instance.DispatchEvent(EventEnum.BATTLE_PASS_TASK_COMPLETE, config, info.TotalNum, config.number,num);
