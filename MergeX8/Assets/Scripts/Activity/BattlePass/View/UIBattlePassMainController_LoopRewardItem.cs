    ...
    public partial class UIBattlePassMainController
    {
        ...
        public class LoopRewardItem : MonoBehaviour
        {
            ...
            private void Awake()
            {
                ...
                UpdateUI();
                EventDispatcher.Instance.AddEventListener(EventEnum.BATTLE_PASS_PURCHASE, UpdateUIEvent);
                EventDispatcher.Instance.AddEventListener(EventEnum.BATTLE_PASS_STORE_REFRESH, UpdateUIEvent);
            }

            private void OnDestroy()
            {
                EventDispatcher.Instance.RemoveEventListener(EventEnum.BATTLE_PASS_PURCHASE, UpdateUIEvent);
                EventDispatcher.Instance.RemoveEventListener(EventEnum.BATTLE_PASS_STORE_REFRESH, UpdateUIEvent);
            }
