...
namespace Activity.BattlePass
{
    ...
    public class BattlePassItem : MonoBehaviour
    {
        ...
        private void Awake()
        {
            EventDispatcher.Instance.AddEventListener(EventEnum.BATTLE_PASS_PURCHASE, UnLockEvent);
            EventDispatcher.Instance.AddEventListener(EventEnum.BATTLE_PASS_PURCHASE_UNLOCK, PurchaseUnLockEvent);
        }
        ...
        {
            EventDispatcher.Instance.RemoveEventListener(EventEnum.BATTLE_PASS_PURCHASE, UnLockEvent);
            EventDispatcher.Instance.RemoveEventListener(EventEnum.BATTLE_PASS_PURCHASE_UNLOCK, PurchaseUnLockEvent);
        }
