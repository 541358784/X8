...
namespace Activity.BattlePass
{
    public partial class UIBattlePassMainController : UIWindowController
    {
        ...
        public override void PrivateAwake()
        {
            ...
            EventDispatcher.Instance.AddEventListener(EventEnum.BATTLE_PASS_PURCHASE, UpdateUI);
            EventDispatcher.Instance.AddEventListener(EventEnum.BATTLE_PASS_STORE_REFRESH, UpdateStore);
            EventDispatcher.Instance.AddEventListener(EventEnum.BATTLE_PASS_COLLECT_LOOP, UpdateUI);
            InitUI();
            UpdateUI();
            ContentSnap();
            UpdateSlider();
        ...
        protected override void OnOpenWindow(params object[] objs)
        {
            ...
            GameBIManager.Instance.SendGameEvent(BiEventAdventureIslandMerge.Types.GameEventType.GameEventBpMainPop,
                openSrc.ToString());
        ...
        private IEnumerator GuideLogic()
        {
            ...
            var dlg = UIManager.Instance.GetOpenedUIByPath(UINameConst.UIPopupBattlePassRefresh);
            if (dlg == null)
            {
                guideTrigger();
                yield break;
            ...
            while (true)
            {
                if (UIManager.Instance.GetOpenedUIByPath(UINameConst.UIPopupBattlePassRefresh) == null)
                    break;
            ...
            while (true)
            {
                if (UIManager.Instance.GetOpenedUIByPath(UINameConst.UIBattlePassReward) == null)
                    break;
        ...
        {
            EventDispatcher.Instance.RemoveEventListener(EventEnum.BATTLE_PASS_PURCHASE, UpdateUI);
            EventDispatcher.Instance.RemoveEventListener(EventEnum.BATTLE_PASS_STORE_REFRESH, UpdateStore);
            EventDispatcher.Instance.RemoveEventListener(EventEnum.BATTLE_PASS_COLLECT_LOOP, UpdateUI);
