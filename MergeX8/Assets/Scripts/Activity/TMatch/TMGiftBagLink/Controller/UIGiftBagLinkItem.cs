...
namespace TMatch
{
    ...
    {
        private int _index;
        private TMGiftBagLinkResourceConfig _giftBagLinkResource;
        ...
        public TMGiftBagLinkResourceConfig giftBagLinkResource
        {
        ...
        public void UpdateData(TMGiftBagLinkResourceConfig data, int index)
        {
            _index = index;
            ...
            UpdateStatus(TMGiftBagLinkModel.Instance.GetCurIndex() == _index);
            UpdateGetButtonText();
        ...
        private void GetRewardClick()
        {
            ...
            EventDispatcher.Instance.DispatchEvent(EventEnum.TM_GIFTBAGLINK_GET_REWARD, this);
        }
