...
public class UIPopupThemeDecorationPreviewController:UIWindowController
{
    ...
    public static UIPopupThemeDecorationPreviewController Open(StorageThemeDecoration storageThemeDecoration)
    {
        return UIManager.Instance.OpenUI(storageThemeDecoration.GetAssetPathWithSkinName(UINameConst.UIPopupThemeDecorationPreview), storageThemeDecoration) as
            UIPopupThemeDecorationPreviewController;
    }
}