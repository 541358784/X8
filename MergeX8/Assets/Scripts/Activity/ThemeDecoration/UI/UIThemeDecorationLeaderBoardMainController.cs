...
public class UIThemeDecorationLeaderBoardMainController:UIWindowController
{
    ...
    private StorageThemeDecorationLeaderBoard _storageWeek;
    ...
    public void BindStorageWeek(StorageThemeDecorationLeaderBoard storageWeek)
    {
    ...
    public void RefreshUI()
    {
        ...
        _buttonClose.gameObject.SetActive(!_storageWeek.CanStorageThemeDecorationLeaderBoardGetReward());
        _buttonCollect.gameObject.SetActive(_storageWeek.CanStorageThemeDecorationLeaderBoardGetReward());
        _buttonShop.gameObject.SetActive(false);
        //更新ui排名逻辑
    ...
    async void OnCollectBtn()
    {
        ...
        if (_storageWeek.CanStorageThemeDecorationLeaderBoardGetReward())
        {
            var success = await _storageWeek.QuitLeaderBoardFromServer();
            if (!success)
                return;
            //没有BI暂时注释掉
            var reasonArgs = new GameBIManager.ItemChangeReasonArgs(){reason = BiEventAdventureIslandMerge.Types.ItemChangeReason.ThemeDecorationLeaderBoardGet};
            ...
            DragonPlus.GameBIManager.Instance.SendGameEvent(
                BiEventAdventureIslandMerge.Types.GameEventType.GameEventThemeDecorationLeaderBoard,
    ...
    //         return;
    //     var startPopup = UIManager.Instance.OpenUI(UINameConst.UIThemeDecorationLeaderBoardStart,true) as UIThemeDecorationLeaderBoardStartController;
    // }
    ...
    public static UIThemeDecorationLeaderBoardMainController Open(StorageThemeDecorationLeaderBoard storageThemeDecoration)
    {
        var mainWindow = UIManager.Instance.OpenUI(storageThemeDecoration.GetAssetPathWithSkinName(UINameConst.UIThemeDecorationLeaderBoardMain)) as UIThemeDecorationLeaderBoardMainController;
        if (!mainWindow)
            return null;
        mainWindow.BindStorageWeek(storageThemeDecoration);
        return mainWindow;
    }
}