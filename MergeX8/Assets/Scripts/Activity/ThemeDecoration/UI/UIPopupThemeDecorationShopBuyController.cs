...
public class UIPopupThemeDecorationShopBuyController:UIWindowController
{
    ...
    protected override void OnOpenWindow(params object[] objs)
    {
        ...
        StoreItemConfig = objs[0] as ThemeDecorationStoreItemConfig;
        Storage = objs[1] as StorageThemeDecoration;
        UpdateUI();
    }
    ...
    public static UIPopupThemeDecorationShopBuyController Open(ThemeDecorationStoreItemConfig storeItemConfig,StorageThemeDecoration storage)
    {
        return UIManager.Instance.OpenUI(storage.GetAssetPathWithSkinName(UINameConst.UIPopupThemeDecorationShopBuy), storeItemConfig,storage) as
            UIPopupThemeDecorationShopBuyController;
    }
}