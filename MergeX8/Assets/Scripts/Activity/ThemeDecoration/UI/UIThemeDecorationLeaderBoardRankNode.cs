 ...
 namespace ThemeDecorationLeaderBoard
 {
     ...
     public class RewardGroupNode : TransformHolder
     {
         ...
         public virtual void BindPlayer(ThemeDecorationLeaderBoardPlayer player)
         {
     ...
     public class NormalRankNode : RankNode
     {
         public class NormalPlayerNode : TransformHolder
         {
             ...
             private ThemeDecorationLeaderBoardPlayer player;
             public void BindPlayer(ThemeDecorationLeaderBoardPlayer inPlayer)
             {
         ...
         private ThemeDecorationLeaderBoardPlayer player;
         public override void BindPlayer(ThemeDecorationLeaderBoardPlayer inPlayer)
         {
             player = inPlayer;
             UpdateHeadIcon();
     ...
     public abstract class RankNode : TransformHolder
     {
         ...
         public abstract void BindPlayer(ThemeDecorationLeaderBoardPlayer player);
     }
 }