...
public class UIPopupZumaPreviewController:UIWindowController
{
    ...
    public static UIPopupZumaPreviewController Open(StorageZuma storageZuma)
    {
        return UIManager.Instance.OpenUI(UINameConst.UIPopupZumaPreview, storageZuma) as
            UIPopupZumaPreviewController;
    }
}