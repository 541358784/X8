...
public partial class UIZumaShopController:UIWindowController
{
    ...
    public override void PrivateAwake()
    {
        ...
        // {
        //     // GuideSubSystem.Instance.FinishCurrent(GuideTargetType.ZumaPreview);
        ...
        //         foreach (var pair in ZumaModel.Instance.StoreItemConfig)
        //         {
        //             var config = pair.Value;
        //             var type = (ZumaStoreItemType)config.Type;
        //             if (type == ZumaStoreItemType.BuildItem)
        //             {
        ...
        //         {
        //             if (rewards[i] == ZumaModel.Instance.GlobalConfig.CenterDecoItem)
        //             {
        //                 rewards.RemoveAt(i);
        //                 rewards.Insert(0,ZumaModel.Instance.GlobalConfig.CenterDecoItem);
        //                 break;
        //             }
        //         }
        //         Action callback = ()=>
    ...
    protected override void OnOpenWindow(params object[] objs)
    {
        ...
        UpdateScoreText();
        var storeLevelConfigList = ZumaModel.Instance.StoreLevelConfig;
    ...
    public static UIZumaShopController Instance;
    public static UIZumaShopController Open(StorageZuma storageZuma)
    {
        Instance = UIManager.Instance.OpenUI(UINameConst.UIZumaShop, storageZuma) as
            UIZumaShopController;
        return Instance;
    }
}