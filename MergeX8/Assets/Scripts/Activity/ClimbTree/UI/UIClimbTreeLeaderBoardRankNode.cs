 ...
 namespace ClimbTreeLeaderBoard
 {
     ...
     public class RewardGroupNode : TransformHolder
     {
         ...
         public virtual void BindPlayer(ClimbTreeLeaderBoardPlayer player)
         {
     ...
     public class NormalRankNode : RankNode
     {
         public class NormalPlayerNode : TransformHolder
         {
             ...
             private ClimbTreeLeaderBoardPlayer player;
             public void BindPlayer(ClimbTreeLeaderBoardPlayer inPlayer)
             {
         ...
         private ClimbTreeLeaderBoardPlayer player;
         public override void BindPlayer(ClimbTreeLeaderBoardPlayer inPlayer)
         {
             if (player != null && player.IsMe)
                 EventDispatcher.Instance.RemoveEventListener(EventEnum.UPDATE_HEAD,UpdateHeadIcon);
             player = inPlayer;
     ...
     public abstract class RankNode : TransformHolder
     {
         ...
         public abstract void BindPlayer(ClimbTreeLeaderBoardPlayer player);
     }
 }