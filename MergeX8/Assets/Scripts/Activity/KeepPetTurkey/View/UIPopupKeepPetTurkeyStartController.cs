...
public class UIPopupKeepPetTurkeyStartController : UIWindowController
{
    ...
    private StorageKeepPetTurkey CurStorage;
    protected override void OnOpenWindow(params object[] objs)
    {
        base.OnOpenWindow(objs);
        CurStorage = objs[0] as StorageKeepPetTurkey;
    ...
    public void OnClickStartBtn()
    {
        ...
        AnimCloseWindow(() =>
        {
            KeepPetModel.Instance.OpenMainView("KeepPetTurkey");
        });
    }

    public static UIPopupKeepPetTurkeyStartController Open(StorageKeepPetTurkey storage)
    {
        var uiPath = UINameConst.UIPopupKeepPetTurkeyStart;
        if (!UIManager.Instance.GetOpenedUIByPath(uiPath))
            return UIManager.Instance.OpenUI(uiPath,storage) as UIPopupKeepPetTurkeyStartController;
        return UIManager.Instance.GetOpenedUIByPath(uiPath) as UIPopupKeepPetTurkeyStartController;
    }
}