...
public class UIPopupKeepPetTurkeyShopBuyController:UIWindowController
{
    ...
    protected override void OnOpenWindow(params object[] objs)
    {
        ...
        StoreItemConfig = objs[0] as KeepPetTurkeyStoreItemConfig;
        Storage = objs[1] as StorageKeepPetTurkey;
        UpdateUI();
    }
    ...
    public void UpdateUI()
    {
        if ((KeepPetTurkeyStoreItemType) StoreItemConfig.Type == KeepPetTurkeyStoreItemType.BuildItem)
        {
            ...
            Icon.sprite = ResourcesManager.Instance.GetSpriteVariant(itemConfig.IconAtlasName, itemConfig.IconSmallAssetName);
    ...
    public static UIPopupKeepPetTurkeyShopBuyController Instance;
    public static UIPopupKeepPetTurkeyShopBuyController Open(KeepPetTurkeyStoreItemConfig storeItemConfig,StorageKeepPetTurkey storage)
    {
        Instance = UIManager.Instance.OpenUI(UINameConst.UIPopupKeepPetTurkeyShopBuy, storeItemConfig,storage)as
            UIPopupKeepPetTurkeyShopBuyController;
        return Instance;
    }
}