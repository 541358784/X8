...
public class UIPopupKapiScrewStartController : UIWindowController
{
    ...
    //     }
    // }
    private StorageKapiScrew CurStorage;
    protected override void OnOpenWindow(params object[] objs)
    {
        base.OnOpenWindow(objs);
        CurStorage = objs[0] as StorageKapiScrew;
    ...
    public void OnClickStartBtn()
    {
        ...
        AnimCloseWindow(() =>
        {
            UIKapiScrewMainController.Open(KapiScrewModel.Instance.Storage);
        });
    }

    public static UIPopupKapiScrewStartController Open(StorageKapiScrew storage)
    {
        var uiPath = UINameConst.UIPopupKapiScrewStart;
        if (!UIManager.Instance.GetOpenedUIByPath(uiPath))
            return UIManager.Instance.OpenUI(uiPath,storage) as UIPopupKapiScrewStartController;
        return UIManager.Instance.GetOpenedUIByPath(uiPath) as UIPopupKapiScrewStartController;
    }
}