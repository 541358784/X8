...
public class UIPopupKapiScrewPreviewController:UIWindowController
{
    ...
    public static UIPopupKapiScrewPreviewController Open(StorageKapiScrew storageKapiScrew)
    {
        return UIManager.Instance.OpenUI(UINameConst.UIPopupKapiScrewPreview, storageKapiScrew) as
            UIPopupKapiScrewPreviewController;
    }
}