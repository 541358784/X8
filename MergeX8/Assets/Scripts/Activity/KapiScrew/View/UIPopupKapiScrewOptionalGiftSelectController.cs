...
public class UIPopupKapiScrewOptionalGiftSelectController : UIWindowController
{
    public static UIPopupKapiScrewOptionalGiftSelectController Open(int a,List<int> b,List<int> c)
    {
        return UIManager.Instance.OpenUI(UINameConst.UIPopupKapiScrewOptionalGiftSelect,a,b,c) as UIPopupKapiScrewOptionalGiftSelectController;
    }
    ...
    private void OnBtnSure()
    {
        if (_selectId > 0)
        {
            KapiScrewModel.Instance.AddSelect(_index,_selectId);
