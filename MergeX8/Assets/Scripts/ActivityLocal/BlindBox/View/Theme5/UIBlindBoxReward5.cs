...
public class UIBlindBoxReward5:UIBlindBoxRewardBase
{
    ...
    public class GroupItem : MonoBehaviour
    {
        ...
        public UIBlindBoxReward5 Controller;
        ...
        public void Init(BlindBoxGroupConfig config,UIBlindBoxReward5 controller)
        {
            Config = config;
        ...
        public class GroupItemView : MonoBehaviour
        {
            ...
            public void Init(BlindBoxGroupConfig config,UIBlindBoxReward5 controller, bool isCollect, bool isSpecial)
            {
                Config = config;
                Controller = controller;
                IsCollect = isCollect;
