...
public class UIBlindBoxTheme5:UIBlindBoxThemeBase
{
   ...
   public class Theme1Item : MonoBehaviour
   {
      ...
      public UIBlindBoxTheme5 Controller;
      ...
      public void Init(BlindBoxItemConfig config,UIBlindBoxTheme5 controller)
      {
         Config = config;
