...
public class UIBlindBoxTheme2:UIBlindBoxThemeBase
{
   ...
   public class Theme1Item : MonoBehaviour
   {
      ...
      public UIBlindBoxTheme2 Controller;
      ...
      public void Init(BlindBoxItemConfig config,UIBlindBoxTheme2 controller)
      {
         Config = config;
