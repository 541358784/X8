...
public class UIBlindBoxReward2:UIBlindBoxRewardBase
{
    ...
    public class GroupItem : MonoBehaviour
    {
        ...
        public UIBlindBoxReward2 Controller;
        ...
        public void Init(BlindBoxGroupConfig config,UIBlindBoxReward2 controller)
        {
            Config = config;
        ...
        public class GroupItemView : MonoBehaviour
        {
            ...
            public void Init(BlindBoxGroupConfig config,UIBlindBoxReward2 controller, bool isCollect, bool isSpecial)
            {
                Config = config;
                Controller = controller;
                IsCollect = isCollect;
