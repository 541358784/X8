...
public class UIBlindBoxReward3:UIBlindBoxRewardBase
{
    ...
    public class GroupItem : MonoBehaviour
    {
        ...
        public UIBlindBoxReward3 Controller;
        ...
        public void Init(BlindBoxGroupConfig config,UIBlindBoxReward3 controller)
        {
            Config = config;
        ...
        public class GroupItemView : MonoBehaviour
        {
            ...
            public void Init(BlindBoxGroupConfig config,UIBlindBoxReward3 controller, bool isCollect, bool isSpecial)
            {
                Config = config;
                Controller = controller;
                IsCollect = isCollect;
