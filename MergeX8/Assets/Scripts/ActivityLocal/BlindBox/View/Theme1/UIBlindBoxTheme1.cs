...
public class UIBlindBoxTheme1:UIBlindBoxThemeBase
{
   ...
   public class Theme1Item : MonoBehaviour
   {
      ...
      public UIBlindBoxTheme1 Controller;
      public StorageBlindBox Storage => Controller.Storage;
      private Transform NoIcon;
      ...
      public void Init(BlindBoxItemConfig config,UIBlindBoxTheme1 controller)
      {
         Config = config;
         Controller = controller;
         NoIcon = transform.Find("NoIcon");
