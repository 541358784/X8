...
public class UIBlindBoxTheme4:UIBlindBoxThemeBase
{
   ...
   public class Theme1Item : MonoBehaviour
   {
      ...
      public UIBlindBoxTheme4 Controller;
      ...
      public void Init(BlindBoxItemConfig config,UIBlindBoxTheme4 controller)
      {
         Config = config;
