...
public class UIBlindBoxReward4:UIBlindBoxRewardBase
{
    ...
    public class GroupItem : MonoBehaviour
    {
        ...
        public UIBlindBoxReward4 Controller;
        ...
        public void Init(BlindBoxGroupConfig config,UIBlindBoxReward4 controller)
        {
            Config = config;
        ...
        public class GroupItemView : MonoBehaviour
        {
            ...
            public void Init(BlindBoxGroupConfig config,UIBlindBoxReward4 controller, bool isCollect, bool isSpecial)
            {
                Config = config;
                Controller = controller;
                IsCollect = isCollect;
