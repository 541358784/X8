...
[System.Serializable]
public class KeepPetDailyTaskConfig : TableBase
{   
    // 编号
    public int Id { get; set; }// 分组
    public int PayLevelGroup { get; set; }// 收集类型(-1:戳气泡,-2:闪购,-3:获得金币)
    ...
    public string LabelText { get; set; }// 解锁狗等级
    public int UnLockLevel { get; set; }// 未解锁最大值收集数量
    public int UnLockMaxValue { get; set; }
