...
public partial class UIPopupTeamMemberInfoController
{
    ...
    private void Awake_Activity()
    {
        ...
        {
            var name = _activityName[i];
            _activityItems.Add(new ActivityItem(transform.Find("Root/Activity1/Content/"+name), ExtraData.StatusList[name]));
        }
    }
}