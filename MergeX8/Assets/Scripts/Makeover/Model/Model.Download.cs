...
namespace ASMR
{
    public partial class Model
    {
        ...
        public List<AssetGroup> GetNeedDownloadAssetGroups(int levelId)
        {
            ...
            assets.Add(new AssetGroup("Asmr", $"makeover/levels/level{levelId}/prefabs.ab"));
            assets.Add(new AssetGroup("Asmr", $"makeover/levels/level{levelId}/audio.ab"));

            if (levelId == 1001)
            {
                assets.Add(new AssetGroup("Asmr", $"makeover/levels/level{levelId}/video.ab"));
            }
            return assets;
        }
        ...
        public List<AssetGroup> GetBaseDownloadAssetGroups()
        {
            ...
            assets.Add(new AssetGroup("Asmr", $"makeover/levels/level{1}/prefabs.ab"));
            assets.Add(new AssetGroup("Asmr", $"makeover/levels/level{1}/audio.ab"));
            assets.Add(new AssetGroup("Asmr", $"spriteatlas/makeoveratlas/{variantPostFix}.ab"));
            assets.Add(new AssetGroup("Asmr", "prefabs/uimakeover.ab"));
