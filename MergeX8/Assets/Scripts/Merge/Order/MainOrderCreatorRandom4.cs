...
{
    public class MainOrderCreatorRandom4 //5分钟cd
    {
        public static SlotDefinition _orgSlot = SlotDefinition.Slot5;
        public static MainOrderType _orgType = MainOrderType.Random4;
