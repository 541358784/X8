 ...
 namespace CommonLeaderBoard
 {
     ...
     public class RewardGroupNode : TransformHolder
     {
         public class RewardNode : TransformHolder
         {
             ...
             public void UpdateState(ResData resData)
             {
                 ...
                 {
                     Show();
                     _rewardSprite.sprite = UserData.GetResourceIcon(resData.id, UserData.ResourceSubType.Big);
         ...
         public virtual void BindPlayer(CommonLeaderBoardPlayer player)
         {
     ...
     public class NormalRankNode : RankNode
     {
         public class NormalPlayerNode : TransformHolder
         {
             ...
             public NormalPlayerNode(Transform transform) : base(transform)
             {
                 ...
                 CollectItemIcon = transform.Find("BGGroup/BG/Icon").GetComponent<Image>();
                 EnableDestroy();
             }
             ...
             {
                 _nameText.text = player.GetAvatarViewState().UserName;
             }

             private CommonLeaderBoardPlayer player;
             public void BindPlayer(CommonLeaderBoardPlayer inPlayer)
             {
                 ...
                 UpdateName();
                 _starNumText.SetText(player.CurrentStruct.StarCount.ToString());
         ...
         private CommonLeaderBoardPlayer player;
         public override void BindPlayer(CommonLeaderBoardPlayer inPlayer)
         {
             player = inPlayer;
             UpdateHeadIcon();
     ...
     public class TopRankNode : RankNode
     {
         ...
         public TopRankNode(Transform transform) : base(transform)
         {
             ...
             CollectItemIcon = transform.Find("Image (3)").GetComponent<Image>();
             EnableDestroy();
         }
     ...
     public abstract class RankNode : TransformHolder
     {
         ...
         public abstract void BindPlayer(CommonLeaderBoardPlayer player);
     }
 }