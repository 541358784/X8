...
public class SingleColumnWheel
{
    ...
    protected Transform _rollTransform;

    protected List<Transform> _elementContainer;
    ...
    public SingleColumnWheel(Transform inTransform, float wheelHeight, int inRowCount,
    ...
    {
        _rollTransform.gameObject.RemoveAllChildren();
    ...
    public void SetUpRoll(float wheelHeight)
    {
        ...
        DefaultContainer = _rollTransform.Find("Container");
        ...
        {
            var container = GameObject.Instantiate(DefaultContainer, _rollTransform);
    ...
    public void StartSpinning(SimpleRollUpdaterEasingConfig inEasingConfig, Action inSpinEndCallback, int startIndex,
        Action bounceBack = null, Action startSlowDown = null, bool keepSpinning = false)
    {
        easingConfig = inEasingConfig;
    ...
    public virtual void ActionAfterUpdate()
    {
