...
namespace fsm_new
{
    public class AsmrState_Swipe_Double : AsmrState_ProcessBase
    {
        private AsmrInputHandler_Swipe_Double _inputHandler;

        private float _totalDistance;
        private Vector3 _hintHandPos;

        private string _animName = "loop2";
        ...
        public override void OnEnter(FsmStateParamBase stateParam)
        {
            ...
            _inputHandler = new AsmrInputHandler_Swipe_Double();
        ...
        public override void Update()
        {
...

            {
                ...
                {
                    if (levelSpinePlayer.Finish) continue;
