...
public class UINewDailyPackController : UIWindowController
{
    private Transform rewardParent;
    private Button closeButton;
    private static string coolTimeKey = "NewDailyPack";
    ...
    protected override void OnOpenWindow(params object[] objs)
    {
        ...
        rewardItems2.gameObject.SetActive(false);
        {
            ...
            var packItem = Instantiate(rewardItems2,rewardParent).gameObject.AddComponent<UINewDailNewyBundleItem>();
            packItem.transform.localScale=Vector3.one;
            packItem.gameObject.SetActive(true);
            var pi = GlobalConfigManager.Instance.GetNewDailyPackPackageConfig(lastPackInfo.PackInfoId);
