...
public class Aux_SummerWatermelonBreadGift : Aux_ItemBase
{
    ...
    public override void UpdateUI()
    {
        ...
        if (!gameObject.activeSelf)
            return;
        _timeText.SetText(SummerWatermelonBreadModel.Instance.GetPackageLeftTimeText(package));
    }
    ...
    protected override void OnButtonClick()
    {
        ...
        if (package == null)
            return;
        SummerWatermelonBreadModel.Instance.OpenGiftPopup(package);
    }
