...
public class Aux_PayRebateLocal : Aux_ItemBase
{
    ...
    {
        gameObject.SetActive(PayRebateLocalModel.Instance.IsOpened());
        _redPoint.gameObject.SetActive(PayRebateLocalModel.Instance.IsCanClaim());
