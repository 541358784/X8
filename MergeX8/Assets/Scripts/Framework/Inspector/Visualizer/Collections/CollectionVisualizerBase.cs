...
namespace DataInspector
{
    ...
    public abstract class CollectionVisualizerBase : VisualizerBase, GUIContainerTools.IDictParser
    {
        ...
        public virtual Type ValueType(object collection)
        {
            return null;
        }
        ...
        public virtual int Size(object collection)
        {
            return 0;
        }

        // 可选功能：Resizable
        public virtual bool Resizable(object collection)
        {
            return false;
        } // 如果Resizable为false，则不需要实现Resize

        public virtual object Resize(object collection, int size)
        {
            return collection;
        } // 返回新大小的容器（可以是自己）
    }
