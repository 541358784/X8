    ...
    public static partial class GUITools
    {
        ...
        public static bool IsInEditor()
        {
            if (cached_s_SkinMode == null)
                cached_s_SkinMode =
                    typeof(GUIUtility).GetField("s_SkinMode", BindingFlags.NonPublic | BindingFlags.Static);
