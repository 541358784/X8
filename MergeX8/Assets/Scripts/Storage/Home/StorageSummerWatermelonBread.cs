/************************************************
 * Storage class : StorageSummerWatermelonBread
...
{
    [System.Serializable]
    public class StorageSummerWatermelonBread : StorageBase
    {
        ...
        // 已购买的礼包SHOPID(弃用)
        [JsonProperty]
        StorageList<int> buyPackageShopIdList = new StorageList<int>();
        [JsonIgnore]
        public StorageList<int> BuyPackageShopIdList
        {
            get
            {
                return buyPackageShopIdList;
            }
        }
        // ---------------------------------//
