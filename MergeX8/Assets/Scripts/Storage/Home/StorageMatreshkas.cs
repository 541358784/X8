/************************************************
 * Storage class : StorageMatreshkas
...
{
    [System.Serializable]
    public class StorageMatreshkas : StorageBase
    {
        ...
        // 回收ID
        [JsonProperty]
        StorageList<int> recycleIds = new StorageList<int>();
        [JsonIgnore]
        public StorageList<int> RecycleIds
        {
            get
            {
                return recycleIds;
