/************************************************
 * Storage class : StorageLimitOrderLine
...
{
    [System.Serializable]
    public class StorageLimitOrderLine : StorageBase
    {
        ...
        // 展示动画标记
        [JsonProperty]
        StorageList<int> showAnimState = new StorageList<int>();
        [JsonIgnore]
        public StorageList<int> ShowAnimState
        {
            get
            {
                return showAnimState;
            }
        }
        // ---------------------------------//
