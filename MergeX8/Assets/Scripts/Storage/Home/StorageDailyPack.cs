/************************************************
 * Storage class : StorageDailyPack
...
{
    [System.Serializable]
    public class StorageDailyPack : StorageBase
    {
        ...
        // 礼包内容
        [JsonProperty]
        StorageList<StorageDailyPackItem> packInfo = new StorageList<StorageDailyPackItem>();
        [JsonIgnore]
        public StorageList<StorageDailyPackItem> PackInfo
        {
            get
            {
                return packInfo;
