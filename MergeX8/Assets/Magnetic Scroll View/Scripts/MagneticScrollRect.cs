...
namespace MagneticScrollView
{
    ...
    public class MagneticScrollRect : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        public void ScrollForward ()
        {
            ...
            //DragonPlus.GameBIManager.Instance.SendGameEvent(DragonU3DSDK.Network.API.Protocol.BiEventAdventureIslandMerge.Types.GameEventType.GameEventFteFirstLevelHelpNext);
        }
