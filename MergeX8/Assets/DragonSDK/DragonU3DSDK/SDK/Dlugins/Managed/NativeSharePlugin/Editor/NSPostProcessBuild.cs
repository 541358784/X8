...
public class NSPostProcessBuild
{
    ...
    private const string LOCATION_IN_USE_USAGE_DESCRIPTION = "Used to deliver better advertising experience";
...
#pragma warning disable 0162
    ...
    public static void OnPostprocessBuild(BuildTarget target, string buildPath)
    {
        ...
        if (target == BuildTarget.iOS)
        {
            ...
            rootDict.SetString("NSLocationWhenInUseUsageDescription", LOCATION_IN_USE_USAGE_DESCRIPTION);
