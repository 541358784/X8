...
#pragma mark - Reload Ad

- (void)disposeInterstitialAd:(nullable NSString*)adUnitIdentifier
{
    MAInterstitialAd *result = self.interstitials[adUnitIdentifier];
    if (result)
    {
        [self.interstitials removeObjectForKey:adUnitIdentifier];
    }
}

- (void)disposeRewardedVideoAd:(nullable NSString*)adUnitIdentifier
{
    MARewardedAd *result = self.rewardedAds[adUnitIdentifier];
    if (result)
    {
