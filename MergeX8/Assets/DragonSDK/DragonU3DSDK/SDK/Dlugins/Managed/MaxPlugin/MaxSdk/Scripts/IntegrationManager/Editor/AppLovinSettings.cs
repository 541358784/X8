...
public class AppLovinSettings : ScriptableObject
{
    ...
    {
        //！！！！！非常重要，此行代码在版本更新中不要修改。如有更新必要，找Simon or liqibo！！！！！
        get { return EditorPrefs.HasKey("BuildIsDebug") && !EditorPrefs.GetBool("BuildIsDebug"); }
    ...
    public string AdMobAndroidAppId
    {
        get
        {
            ...
            if (info != null && info.m_Map.ContainsKey(Constants.Admob))
            {
                AdmobConfigInfo admobInfo = info.m_Map[Constants.Admob] as AdmobConfigInfo;
                if(admobInfo != null)
                    return admobInfo.AndroidAppID;
            }
