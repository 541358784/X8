...
namespace AppLovinMax.Scripts.IntegrationManager.Editor
{
    ...
    public class AppLovinPostProcessiOS
    {
        ...
        public static void OnPostProcessBuild(BuildTarget buildTarget, string buildPath)
        {
            ...
            Dlugin.MAXConfigInfo m_ConfigInfo = Dlugin.PluginsInfoManager.Instance.GetPluginConfig<Dlugin.MAXConfigInfo>(Dlugin.Constants.MAX);

            var sdkKey = "";

            if (m_ConfigInfo != null)
            {
                sdkKey = m_ConfigInfo.SDKKey;
            }
            ...
            using (var unityWebRequest = new UnityWebRequest("https://api2.safedk.com/v1/build/ios_setup2"))
            {
                ...
                EditorPrefs.SetBool("AppLovinQualityServiceState", result.ExitCode == 0);
            }
        }
