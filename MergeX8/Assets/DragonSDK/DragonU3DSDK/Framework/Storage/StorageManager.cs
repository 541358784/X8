    ...
    public class StorageManager : Manager<StorageManager>
    {
        ...
        void UpdateStorageCommon()
        {
            ...
            if (adjustPlugin != null)
            {
                ...
                var attributionData = adjustPlugin.GetAdjustAttribution();
                if (attributionData != null)
                {
                    if (string.IsNullOrEmpty(storageCommon.Marketing.Tracker))
                    {
                        storageCommon.Marketing.Tracker = attributionData.trackerName;
                    }

                    if (string.IsNullOrEmpty(storageCommon.Marketing.Network))
                    {
                        storageCommon.Marketing.Network = attributionData.network;
                    }

                    if (string.IsNullOrEmpty(storageCommon.Marketing.Campaign))
                    {
                        storageCommon.Marketing.Campaign = attributionData.campaign;
                    }

                    if (string.IsNullOrEmpty(storageCommon.Marketing.AdGroup))
                    {
                        storageCommon.Marketing.AdGroup = attributionData.adgroup;
                    }

                    if (string.IsNullOrEmpty(storageCommon.Marketing.Creative))
                    {
                        storageCommon.Marketing.Creative = attributionData.creative;
                    }

                    if (string.IsNullOrEmpty(storageCommon.Marketing.ClickLabel))
                    {
                        storageCommon.Marketing.ClickLabel = attributionData.clickLabel;
                    }
                    if (string.IsNullOrEmpty(storageCommon.Marketing.FbInstallReferrer))
                    {
                        storageCommon.Marketing.FbInstallReferrer = attributionData.fbInstallReferrer;
                    }
                }
            }
