...
namespace DragonU3DSDK.SDKEvents
{
    ...
    public class UnfulfilledPaymentPending : Subject<UnfulfilledPaymentPending>
    {
        public DragonU3DSDK.UnfulfilledPayment data;
        public UnfulfilledPaymentPending Data(DragonU3DSDK.UnfulfilledPayment data)
        {
            this.data = data;
            return this;
        }
    ...
    [Obsolete("DragonU3DSDK.SDKEvents.ReauthFacebookDataAccessPopEvent is deprecated")]
    public class ReauthFacebookDataAccessPopEvent : Subject<ReauthFacebookDataAccessPopEvent>
    {
    }

    [Obsolete("DragonU3DSDK.SDKEvents.ReauthFacebookDataAccessSuccessEvent is deprecated")]
    public class ReauthFacebookDataAccessSuccessEvent : Subject<ReauthFacebookDataAccessSuccessEvent>
    {
    }

    [Obsolete("DragonU3DSDK.SDKEvents.ReauthFacebookDataAccessFailureEvent is deprecated")]
    ...
    [Obsolete("DragonU3DSDK.SDKEvents.ReauthFacebookAccessTokenPopEvent is deprecated")]
    public class ReauthFacebookAccessTokenPopEvent : Subject<ReauthFacebookAccessTokenPopEvent>
    {
    }

    [Obsolete("DragonU3DSDK.SDKEvents.ReauthFacebookAccessTokenSuccessEvent is deprecated")]
    public class ReauthFacebookAccessTokenSuccessEvent : Subject<ReauthFacebookAccessTokenSuccessEvent>
    {
    }

    [Obsolete("DragonU3DSDK.SDKEvents.ReauthFacebookAccessTokenFailureEvent is deprecated")]
    ...
    public class FireBaseOnMessageReceivedEvent : Subject<FireBaseOnMessageReceivedEvent>
    {
        public FirebaseMessage message;
        public FireBaseOnMessageReceivedEvent Data(FirebaseMessage inMessage)
        {
