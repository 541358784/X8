	...
	SubShader
	{
		...
		Pass 
		{
			...
			float4 frag( v2f i ) : COLOR
			{
                ...
                float3 emissive = (_MainColor.rgb*_Brightness*pow(_MainTex_var.rgb,_Contrast)*i.vertexColor.rgb)*(_MainColor.a*_MainTex_var.a*i.vertexColor.a*_MaskTex_var.r);
